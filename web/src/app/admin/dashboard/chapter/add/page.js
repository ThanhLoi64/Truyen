...
import { addChapterToSeriesAdmin } from '@/app/api/user';
import { FormHelperText, Alert, Container, Typography, Box, TextField, FormControlLabel, Checkbox, Button, Snackbar } from '@mui/material';
...
const AddChapterPage = () => {
  ...
  const handleSubmit = async (e, saveDraft, savePublic) => {
    ...
    try {
      await addChapterToSeriesAdmin(chapterData);
      if (isMounted.current) {
