...
import { AdminfetchListBook, deleteSeriesAdmin } from "@/app/api/user";
...
const DataGridDemo = () => {
  ...
  const fetchData = async () => {
    ...
    try {
      ...
      let data;
      do {
        data = await AdminfetchListBook(currentPage);
        if (data && data.items) {
  ...
  return (
    <div className="pl-[16rem]">
      <div className="flex justify-between items-center py-1">
        ...
        />
        <Link
          href="/admin/dashboard/listbook/add"
        ...
        <table className="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
          <thead className="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
            <tr>
              ...
              <th scope="col" className="px-2 py-1 truncate">Người dùng</th>
          ...
          <tbody>
            {rows.map((product, index) => (
              ...
              >
                ...
                <td className="max-w-8 px-2 font-medium text-gray-900 whitespace-nowrap dark:text-white truncate">
                  {product.userName}
                </td>
                ...
                <td className="px-2 text-center">
                  <Link
                    href={`/admin/dashboard/listbook/edit?postId=${product.id}`}
                  ...
                  <Link
                    href={`/admin/dashboard/chapter/add?postId=${product.id}`}
