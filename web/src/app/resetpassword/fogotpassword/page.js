        ...
        <div className="w-full p-6 bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-md dark:bg-gray-50 dark:border-gray-100 sm:p-8 text-black">
          ...
          <form className="mt-4 space-y-4 lg:mt-5 md:space-y-5" action="#">
            <div>
              ...
              >
                Mã xác thực đã được gửi qua email của bạn, vui lòng kiểm tra
                Email và nhập mã xác thực của bạn *
              </label>
              <input
                type="token"
                name="token"
                id="token"
                className="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:border-gray-600 dark:placeholder-gray-400 dark:text-gray-600 dark:focus:ring-blue-500 dark:focus:border-blue-500"
